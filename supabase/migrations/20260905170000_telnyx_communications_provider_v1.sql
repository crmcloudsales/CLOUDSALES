...
values
 ('telnyx','sms','https://fkahaqprzgcimgyathqx.supabase.co/functions/v1/telnyx-webhook','pending',array['message.received','message.sent','message.finalized']::text[],jsonb_build_object('signature','ed25519','timestamp_tolerance_seconds',300)),
 ('telnyx','whatsapp','https://fkahaqprzgcimgyathqx.supabase.co/functions/v1/telnyx-webhook','pending',array['message.received','message.sent','message.finalized']::text[],jsonb_build_object('signature','ed25519','timestamp_tolerance_seconds',300))
on conflict(provider_key,channel) do update set
