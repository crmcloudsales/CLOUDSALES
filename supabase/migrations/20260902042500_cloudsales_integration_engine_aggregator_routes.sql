...
('ayrshare','Ayrshare','other','api_key','planned',107,jsonb_build_object('provider_type','unified_social_api','routing_role','aggregator','api_base_url','https://app.ayrshare.com/api','credential_mode','platform_api_key','capabilities',jsonb_build_array('social.read','social.publish','conversation.read','conversation.send','analytics.snapshot'),'preferred_aggregator',false,'internal_only',true)),
('postproxy','Postproxy','other','api_key','planned',108,jsonb_build_object('provider_type','unified_social_api','routing_role','aggregator','credential_mode','platform_api_key','capabilities',jsonb_build_array('social.read','social.publish'),'preferred_aggregator',false,'internal_only',true))
