...
-- Telnyx setup + signed webhook handling run through the existing connection-secret-setup function
-- because the Supabase project is already at its Edge Function count limit.
begin;
