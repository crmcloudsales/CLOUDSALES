...
function fallback(locale: string, kind: string, data: any) {
  ...
  return es
    ? "Cloudy Core está activo y conectado a tus datos. Puedo revisar la operación, diagnosticar CloudSales, generar reportes y administrar AgentCloud según los permisos de tu rol."
    : "Cloudy Core is active and connected to your data. I can inspect operations, diagnose CloudSales, generate reports, and manage AgentCloud according to your role permissions.";
}
...
Deno.serve(async (req) => {
  ...
  async function callModel(model: any, messages: any[], withTools = true) {
