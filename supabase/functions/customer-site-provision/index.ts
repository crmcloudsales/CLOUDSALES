...
Deno.serve(async req=>{
 ...
 try{
  ...
  await upload(t,worker,code,edgeToken,crypto.randomUUID()+crypto.randomUUID(),turn.secret);result.steps.worker={uploaded:true,secrets_bound:true};result.steps.domain=await attach(t,host,worker);
