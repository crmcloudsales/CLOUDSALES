...
function lang(){return (document.documentElement.lang||'en').toLowerCase().startsWith('es')?'es':'en'}
...
const final=`<section class="csFinal" id="cs-story-final"><div class="wrap"><div class="csFinalBox"><div class="csStoryKicker">${x.finalKicker}</div><h2 class="csStoryTitle">${x.finalTitle}</h2><p class="csStoryLead">${x.finalLead}</p><div class="csFinalActions"><a class="btn primary csFinalTrial" href="/subscribe?plan=pro">${x.trial}</a><a class="btn" href="#pricing">${x.plans}</a></div></div></div></section>`;
