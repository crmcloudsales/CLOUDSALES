(() => {
  ...
  function injectStyles(){
    ...
    s.textContent=`
      ...
      .csOpsList{display:grid;gap:8px;margin-top:12px}.csOpsRow{display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #292936;border-radius:14px;background:#121019;padding:12px}.csOpsRow b{font-size:12px}.csOpsRow small{display:block;color:#858596;margin-top:3px}.csOpsActions{display:flex;gap:6px;flex-wrap:wrap;justify-content:flex-end}
