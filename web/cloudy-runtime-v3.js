(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .csVoiceToggle.active{color:#fff;border-color:#8d4f8a;background:#17141F}
      #micBtn{min-width:48px;transition:.18s transform,.18s background,.18s box-shadow}
      #micBtn.csMicLive{background:linear-gradient(135deg,#F955B6,#C13BE4);border-color:transparent;box-shadow:0 0 0 5px #F955B620,0 0 30px #F955B635;transform:scale(1.04)}
      ...
      @media(max-width:700px){.cloudyTop{flex-wrap:nowrap}.cloudyTop .csVoiceControls{margin-left:auto}.composer{justify-content:center;align-items:center;padding:15px!important}.composer textarea,.composer #sendCloudy{display:none!important}#micBtn{width:82px!important;height:82px!important;min-width:82px!important;border-radius:50%!important;display:grid!important;place-items:center!important;background:linear-gradient(145deg,#C13BE4,#F955B6)!important;border:1px solid #f17bd366!important;box-shadow:0 12px 38px #c13a9b45!important;padding:0!important}#micBtn svg{width:34px;height:34px;fill:none;stroke:#fff;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}#micBtn.csMicLive{animation:csMicPulse 1.15s ease-in-out infinite}#micBtn.csMicSpeaking{box-shadow:0 0 0 8px #C13BE418,0 12px 38px #c13a9b55}.csCloudyHint{font-size:11px!important;padding:0 15px 13px!important}.cloudyPanel{grid-template-rows:auto 1fr auto auto!important}.messages{padding-bottom:8px!important}.msg{font-size:13px!important;padding:11px 13px!important;margin:7px 0!important}}
