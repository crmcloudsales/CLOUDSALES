  ...
  function patchCanonicalPricing() {
    const apply = () => {
      ...
      if (plans && !document.getElementById('csUsagePricingNotice')) {
        ...
        notice.innerHTML = '<b>Uso variable transparente.</b> Basic: costo real ×1.50 · Pro: ×1.35 · Premium: ×1.25 · Dominios: ×2. <a href="https://cloudsales.app/usage-pricing" target="_blank" rel="noopener" style="color:#F955B6;text-decoration:underline">Ver Usage Pricing</a>';
